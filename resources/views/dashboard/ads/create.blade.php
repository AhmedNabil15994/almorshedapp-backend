...
@section('title',__('dashboard.ads.create.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('dashboard.ads.create.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="form" role="form" class="form-horizontal form-row-seperated" method="post" action="{{route('ads.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12">
                  @include('dashboard.ads.forms.create')
                    <div class="col-md-12">
