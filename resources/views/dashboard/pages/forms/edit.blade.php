<div class="tab-pane fade active in" id="global_setting">
    ...
    <div class="col-md-10">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <textarea name="description[{{$code}}]" rows="8" cols="80" class="form-control {{check_dir($code)}}Editor" data-name="description.{{$code}}">{!!$page->translate($code)->description!!}</textarea>
                <div class="help-block"></div>
            </div>
        </div>
        @endforeach
