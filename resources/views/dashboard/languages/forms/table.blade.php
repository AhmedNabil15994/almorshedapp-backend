...
<script>
 function tableGenerate(data='') {
    ...
    $('#dataTable').DataTable({
        ajax : {
            url   : "{{ url(route('languages.dataTable')) }}",
            type  : "GET",
            data  : {
                req : data,
            },
        ...
        columns: [
          ...
          {data: 'language' 			  , className: 'dt-center'},
        ...
        columnDefs: [
    			...
    			},
          {
            targets: -1,
            width: '13%',
            title: '{{__('dashboard.ads.datatable.options')}}',
            className: 'dt-center',
            orderable: false,
            render: function(data, type, full, meta) {
              ...
              // Edit
    					...
    					return `
    					@permission('edit_languages')
    						<a href="`+editUrl+`" class="btn btn-sm blue" title="Edit">
    			              <i class="fa fa-edit"></i>
    			            </a>
    					@endpermission

              @permission('delete_languages')
              @csrf
