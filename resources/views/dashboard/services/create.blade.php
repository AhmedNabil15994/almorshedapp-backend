...
@section('title',__('dashboard.services.create.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('dashboard.services.create.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="form" role="form" class="form-horizontal form-row-seperated" method="post" action="{{route('services.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12">
                  @include('dashboard.services.forms.create')
                    <div class="col-md-12">
