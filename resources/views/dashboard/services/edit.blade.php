...
@section('title',__('dashboard.services.edit.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('dashboard.services.edit.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="updateForm" role="form" class="form-horizontal form-row-seperated" method="post" action="{{route('services.update',$service->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                  @include('dashboard.services.forms.edit')
                    <div class="col-md-12">
